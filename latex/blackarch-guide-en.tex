...
\rhead{Przewodnik BlackArch Linux}
...
\end{figure}
\vspace{0.5cm}
\Huge{\textbf{Przewodnik BlackArch Linux}}\\
\vspace{1cm}
...
\section{Overview}
Przewodnik BlackArch Linux jest podzielony na kilka części:
\begin{itemize}
\item Wstęp - Zawiera opis, zapoznanie i dodatkowe informacje o projekcie
\item Przewodnik użytkownika - Wszystko co typowy użytkownik powinien wiedzieć by efektywnie używać BlackArch
\item Przewodnik Developera - Jak zaangażować się w rozwój BlackArch
\item Przewodnik po narzędziach - Szczegółowy opis i przykłady użycia narzędzi wbudowanych (WIP)
\end{itemize}

\section{Co to BlackArch Linux?}
BlackArch to kompletna dystrybucja dla pentesterów.
Opiera się o \href{https://www.archlinux.org/}{ArchLinux} . Użytkownicy mogą instalować komponenty BlackArch'a pojedyńczo lub w grupach bezpośrednio na ArchLinux
...
\section{Zaangażuj się}
Możesz skontaktować się z teamem BlackArch używając tych platform:
